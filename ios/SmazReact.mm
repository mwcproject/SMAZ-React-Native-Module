...
// SMAZ React implementation
@implementation SmazReact

// Export module
RCT_EXPORT_MODULE()

// Compress
RCT_EXPORT_METHOD(compress:(nonnull NSString *)input
	...
	withReject:(RCTPromiseRejectBlock)reject)
{
	...
	try {
		...
		// Resolve compressing input
		resolve(toHexString(compress(inputData.data(), inputData.size())));
	}
...
// Decompress
RCT_EXPORT_METHOD(decompress:(nonnull NSString *)input
	withResolver:(RCTPromiseResolveBlock)resolve
	withReject:(RCTPromiseRejectBlock)reject)
{
	...
	try {
		...
		// Resolve decompressing input
		resolve(toHexString(decompress(inputData.data(), inputData.size())));
	}
